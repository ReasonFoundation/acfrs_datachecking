...
# special cases: Nashville-Davidson metropolitan government (balance) == "Nashville-Davidson County" in ACFRS--> rename to match
...
pop %>% 
  filter(str_detect(county, "Nashville-Davidson|Louisville-Jefferson"))
```
