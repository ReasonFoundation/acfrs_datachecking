...
t1 %>% filter(county == "Menominee County")
...
# entities that are NOT in acafrs databse
t2 %>% left_join(t1) %>% # t1 has no total_liabilities na. 
  filter(is.na(total_liabilities)) # after join, has 169 total_liabilities na => must be entities that are NOT in acfrs database. 
